...
XML_RESPONSE_ORDER_CREATE = (
    ...
    b"<OrderResponse><Order><CustomerOrderId>123456789</CustomerOrderId>"
    b"<Name>Available Telephone Number order</Name>"
    b"<OrderCreateDate>2015-06-20T10:54:08.042Z</OrderCreateDate>"
    b"<BackOrderRequested>false</BackOrderRequested>"
    b"<id>f30a31a1-1de4-4939-b094-4521bbe5c8df</id>"
    b"<ExistingTelephoneNumberOrderType><TelephoneNumberList>"
    b"<TelephoneNumber>9193752369</TelephoneNumber>"
    b"<TelephoneNumber>9193752720</TelephoneNumber></TelephoneNumberList>"
    b"</ExistingTelephoneNumberOrderType><PartialAllowed>true"
    b"</PartialAllowed><SiteId>2297</SiteId></Order>"
    b"<OrderStatus>RECEIVED</OrderStatus></OrderResponse>"
)
...
XML_RESPONSE_ORDER_GET = (
    ...
    b"<ExistingTelephoneNumberOrderType><TelephoneNumberList>"
    b"<TelephoneNumber>9193752369</TelephoneNumber>"
    b"<TelephoneNumber>9193752720</TelephoneNumber>"
    b"<TelephoneNumber>9193752648</TelephoneNumber>"
    b"</TelephoneNumberList></ExistingTelephoneNumberOrderType>"
    b"<PartialAllowed>true</PartialAllowed><SiteId>2297</SiteId></Order>"
    b"<OrderStatus>RECEIVED</OrderStatus></OrderResponse>"
)

XML_RESPONSE_ORDERS_LIST = (
    b"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><"
    b"ResponseSelectWrapper><ListOrderIdUserIdDate><TotalCount>2</TotalCount>"
    b"<Links><first></first></Links><OrderIdUserIdDate>"
    b"<CountOfTNs>0</CountOfTNs><CustomerOrderId>123456789</CustomerOrderId>"
    b"<userId>byo_dev</userId>"
    b"<lastModifiedDate>2015-06-13T16:14:46.017Z</lastModifiedDate>"
    b"<OrderDate>2015-06-13T16:14:45.956Z</OrderDate>"
    b"<OrderType>new_number</OrderType>"
    b"<orderId>016c1aef-a873-4a90-8374-60771cba9452</orderId>"
    b"<OrderStatus>FAILED</OrderStatus></OrderIdUserIdDate>"
    b"<OrderIdUserIdDate><CountOfTNs>0</CountOfTNs>"
    b"<CustomerOrderId>123456789</CustomerOrderId><userId>byo_dev</userId>"
    b"<lastModifiedDate>2015-06-13T16:32:04.216Z</lastModifiedDate>"
    b"<OrderDate>2015-06-13T16:32:04.181Z</OrderDate>"
    b"<OrderType>new_number</OrderType>"
    b"<orderId>77659f47-d527-42ad-bf72-34b6841016ac</orderId>"
    b"<OrderStatus>FAILED</OrderStatus></OrderIdUserIdDate>"
