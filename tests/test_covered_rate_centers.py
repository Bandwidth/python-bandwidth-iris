...
XML_RESPONSE_CRC_LIST_GET = (
    ...
    b"<first>Link=&lt;https://dashboard.bandwidth.com:443/v1.0/coveredRateCenters?"
    b"npa=310&amp;size=10&amp;e mbed=Cities&amp;embed=ZipCodes&amp;embed="
    b"NpaNxxX&amp;page=1&gt;;rel=\"first\";</first><next>Link=&lt;"
    b"https://dashboard.bandwidth.com:443/v1.0/coveredRateCenters?npa=310&amp;"
